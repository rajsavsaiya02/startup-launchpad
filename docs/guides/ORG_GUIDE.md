...
| --- | --- |
| **FOUNDER** | The user who creates the organization becomes the Founder. Ultimate authority. The Founder **cannot leave** the organization. The title of the organization always belongs to this person. The Founder role is never replaced or changed. In the Team Map ("Executive Board"), the Founder has a single, specific, unmovable, and unchangeable position. The Founder can edit the Team Map. |
| **CO-FOUNDER** | Additional members joining with a global 'founder' account role, or granted the status, are considered Co-Founders. They have the exact same authority as the Founder, but unlike the Founder, they **can leave** or be removed. They can be moved in the Team Map to any level. |
| **ADMIN** | High-level management. Can invite/approve/kick Members. Can manage OrganizationDesignations across departments. Can edit the Team Map. Cannot manage the Founder or Co-Founders. |
| **TL (Team Lead)** | Mid-level management. Leads specific teams or departments. Can **only view** the Team Map; they cannot edit it. |
| **EMPLOYEE** | Standard collaborative internal employee. Tracks progress, logs time/expenses, participates in internal conversations. Associated with specific Designations and Cost Rates. |
| **GUEST (Student / Freelancer / External Collaborator)** | Restricted access external worker. Interacts strictly through the confines of their assigned "Gig". Cannot browse broader org projects or financial data unless explicitly assigned. Can **only view** the Team Map; they cannot edit it. |
