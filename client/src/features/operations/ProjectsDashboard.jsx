      ...
      >
        {PROJECTS.map((project) => (
          <div
            key={project.id}
            onDoubleClick={() =>
              navigate(`/productivity/projects/${project.id}`)
            }
            ...
            <Card className="h-full p-6 hover:shadow-lg transition-all duration-300 border-border-light dark:border-border-dark bg-white dark:bg-surface-dark group-hover:border-primary/50">
              <div className="flex justify-between items-start mb-4">
                ...
                <button
                  ...
                  className="text-text-tertiary hover:text-primary transition-colors p-1 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800"
                  title="Open Project"
                >
