...
export function ProjectDetailsPage() {
  ...
  const groupedTasks = () => {
    ...
    activeTasks.forEach((task) => {
      ...
      // A task belongs in Archive if it is DONE AND (it was not completed today OR it is overdue)
      // This ensures that even if completed today, an overdue task (due < today) is archived.
      // Exception: Tasks due TODAY stay active in the TODAY group until the end of the day.
