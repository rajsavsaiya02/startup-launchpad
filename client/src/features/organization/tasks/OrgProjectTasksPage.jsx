      ...
      <div className="shrink-0 px-8 pt-8 pb-0">
        <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-6">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
              Track progress for team initiatives and organizational goals.
            </p>
          </div>
        ...
        <div className="mt-6 border-b border-gray-200 dark:border-gray-700">
          <nav className="-mb-px flex space-x-8">
            {["Overview", "Board", "Activity", "Files", "Members"].map(
              (tab) => (
                <button
                  key={tab}
          ...
          <div className="flex h-full gap-6 min-w-max">
            {COLUMNS.map((col) => (
              <div key={col.id} className="w-[320px] flex flex-col shrink-0">
                {/* Column Header */}
                <div
                  className={`flex items-center justify-between pb-3 border-b-2 ${col.color} mb-4`}
                >
