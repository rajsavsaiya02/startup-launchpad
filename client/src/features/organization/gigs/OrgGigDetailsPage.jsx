...
export function OrgGigDetailsPage() {
  ...
  const gig = {
    ...
    applicants: 17,
    description:
      "We are looking for a creative and detail-oriented designer to lead the revamp of our core mobile application. The ideal candidate will have a strong portfolio showcasing mobile-first designs, proficiency in Figma, and experience with prototyping. You will work closely with our product and engineering teams to deliver a seamless user experience.",
    skills: [
      "Figma",
      "Prototyping",
      "Wireframing",
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-text-secondary dark:text-gray-400">
              <span className="flex items-center gap-1">
                <Building2 className="h-4 w-4" /> {gig.org}
              </span>
              <span className="flex items-center gap-1">
                <Clock className="h-4 w-4" /> Posted {gig.posted}
              </span>
              <span className="flex items-center gap-1">
                <Users className="h-4 w-4" /> {gig.applicants} Applicants
              </span>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <Card className="p-6 space-y-4 bg-white dark:bg-surface-dark">
            <h2 className="text-xl font-bold text-text-primary dark:text-white">
              Organization Gig Description
            </h2>
            <p className="text-text-secondary dark:text-gray-300 leading-relaxed">
              {gig.description}
            </p>
            <div className="pt-4">
              <h3 className="font-semibold text-sm text-text-primary dark:text-white mb-3">
          ...
          <div className="sticky top-24 space-y-6">
            ...
            <Card className="p-6 space-y-6 border-primary/20 shadow-md bg-white dark:bg-surface-dark">
              <div>
                ...
                <p className="text-xs text-text-tertiary">
                  Don't wait! This gig is popular.
                </p>
              </div>
            ...
            <Card className="p-6 bg-white dark:bg-surface-dark">
              ...
              <p className="text-sm text-text-secondary dark:text-gray-400 mb-4">
                Leading the future of mobile technology with innovative
                solutions.
              </p>
