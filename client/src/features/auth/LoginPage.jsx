...
import { Mail, Lock, CheckCircle, ArrowRight, Github, Chrome } from 'lucide-react';
    ...
    >
      ...
      {isVerified && (
        ...
        >
          ...
          <span className="font-medium">Email verified! You can now log in.</span>
        </motion.div>
      )}
      ...
      <div className="text-center text-sm text-gray-500 mt-6">
        ...
        <Link to="/auth/signup" className="font-semibold text-primary hover:text-primary-hover hover:underline transition-colors">
          Create an account
        </Link>
      </div>
      {/* 
