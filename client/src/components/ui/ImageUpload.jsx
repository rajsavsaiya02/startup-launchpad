...
import { Upload, X, ZoomIn, ZoomOut, Image as ImageIcon, Crop as CropIcon } from 'lucide-react';
    ...
    <div className={cn("relative", className)}>
      ...
      <div 
        className={cn(
          ...
          previewUrl ? "h-32 w-32" : "h-32 w-32 border-2 border-dashed border-border-light dark:border-border-dark hover:border-primary/50 cursor-pointer"
        )}
      ...
      >
        {previewUrl ? (
          ...
          <div className="text-center p-4">
             ...
             <p className="text-xs text-text-secondary font-medium group-hover:text-primary transition-colors">Upload</p>
          </div>
        )}
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in">
           <div className="bg-white dark:bg-surface-dark rounded-xl shadow-2xl max-w-lg w-full overflow-hidden relative z-[10000]">
              <div className="px-6 py-4 border-b border-border-light dark:border-border-dark flex justify-between items-center bg-white dark:bg-surface-dark">
                 ...
                 <button onClick={() => setCropModalOpen(false)} className="text-text-tertiary hover:text-text-primary">
                    <X className="h-5 w-5" />
                 </button>
              </div>
              ...
              <div className="px-6 py-4 space-y-4 bg-white dark:bg-surface-dark">
                 ...
                 <div className="flex justify-end gap-3">
                    ...
                    <Button variant="primary" onClick={handleSaveCrop}>Save & Apply</Button>
                 </div>
              </div>
           </div>
        </div>,
