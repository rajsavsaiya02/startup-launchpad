...
const TEAM = [
  {
    name: "Raj Savsaiya",
    role: "Cross Platfrom Developer (TL)",
...
const VALUES = [
  {
    icon: Lightbulb,
    title: "Innovation",
    desc: "Pushing boundaries to solve real founder problems.",
  },
  {
    icon: Target,
    title: "Clarity",
    desc: "Simplicity drives better decisions and faster execution.",
  },
  {
    icon: Users,
    title: "Collaboration",
    desc: "Great products come from strong teams working closely together.",
  },
  {
    icon: ShieldCheck,
    title: "Transparency",
    desc: "Openness builds trust internally and with customers.",
  },
  {
    icon: Rocket,
    title: "Efficiency",
    desc: "Every feature is designed to save founders time and effort.",
  },
  {
    icon: HeartHandshake,
    title: "Reliability",
    desc: "A platform you can trust with your startup's lifeline.",
  },
];
...
export function AboutPage() {
  ...
  const { content, SEO, loading } = useCMSContent("about");
      ...
      <section className="relative py-24 px-6 text-center overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-text-primary dark:text-white mb-8 leading-tight">
            ...
            <span className="text-primary">Indian Unicorns.</span>
          </h1>
          <p className="text-xl text-text-secondary dark:text-gray-300 leading-relaxed max-w-3xl mx-auto">
            {platformName} was born from a simple observation: 90% of startups
            fail not because of bad ideas, but because of operational chaos. We
            exist to close the gap between vision and execution.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-6 text-lg text-text-secondary dark:text-gray-400">
              <p>
                Early-stage founders are often overwhelmed. They juggle project
                management in one tool, finances in a spreadsheet, and hiring on
                a third platform.
              </p>
              <p>
                This fragmentation drains cognitive resources. {platformName}{" "}
                unifies these three critical pillars—
                <strong>Operations, Finance, and Talent</strong>—into a single
                operating system.
              </p>
              <p>
                Built under the guidance of <strong>Prof. Jay Parmar</strong>,
                our platform is designed for the "product-rich but process-poor"
                founder.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-text-secondary">
              The principles that guide how we build and support founders.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {VALUES.map((val, idx) => (
              <Card
                key={idx}
                className="p-8 hover:-translate-y-1 transition-transform duration-300 border-border-light dark:border-border-dark"
              >
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg text-text-secondary mb-16 max-w-2xl mx-auto">
            A passionate team of engineers and designers from Parul University,
            dedicated to solving the startup failure paradox.
          </p>
