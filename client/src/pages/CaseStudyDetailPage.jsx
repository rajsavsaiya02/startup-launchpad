...
export function CaseStudyDetailPage() {
  ...
  const study = {
    ...
    subtitle: `How NextGen AI utilized ${platformName}'s Operational & Financial hubs to demonstrate operational maturity to investors.`,
    company: "NextGen AI",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none text-text-secondary dark:text-gray-300">
              ...
              <p>
                NextGen AI faced a common dilemma: they had a groundbreaking product but chaotic internal operations. Investors were hesitant due to a high, unexplained burn rate. By adopting {platformName}, they centralized their financial tracking and project management, resulting in a <strong>clear, auditable paper trail</strong> that ultimately secured their Series A funding.
              </p>

              <h2 className="text-2xl font-bold text-text-primary dark:text-white mt-12 mb-4">2. The Challenge: "The Context Gap"</h2>
              <p>
                Before {platformName}, the team managed tasks in Trello, finances in Excel, and hiring in email threads. This fragmentation caused:
              </p>
              ...
              <p>
                Within 9 months, the company not only extended their runway by optimizing spend but also presented a comprehensive "Operational Health Report" generated by {platformName} to investors. This transparency was cited as a key factor in their term sheet.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-linear-to-br from-primary to-blue-600 rounded-xl p-6 text-white text-center">
              ...
              <p className="text-sm text-blue-100 mb-6">Start building your success story with {platformName} today.</p>
              <Link to="/auth/signup">
